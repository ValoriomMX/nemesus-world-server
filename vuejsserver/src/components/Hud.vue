...
<div class="hud" style="overflow-y: auto;background-color:transparent; height:100%; width:100%">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-1">
                                        ...
                                        <li class="active">
                                            ...
                                            <input placeholder="180" value="180" v-model="size" type="text" class="form-control mt-1" maxlength="3">
                                        </li>
                                        <li class="active">
                                            <span class="fa fa-tint mt-3 mr-2"></span>Augenfarbe
                                            <input placeholder="Grün" v-model="eyecolor" type="text" class="form-control mt-1" maxlength="10">
                                        </li>
                                        <li class="active">
                                            <span class="fa fa-book mt-3 mr-2"></span>Abschluss
                                            <input placeholder="Realschulabschluss" v-model="education" type="text" class="form-control mt-1" maxlength="64">
                                        </li>
                                        <li class="active">
                                            <span class="fas fa-pencil-alt mt-3 mr-2"></span>Besondere Fähigkeiten
                                            <input placeholder="Schwimmen, Autoaffin, Geduldig" v-model="skills" type="text" class="form-control mt-1" maxlength="64">
                                        </li>
                                        <li class="active">
                                            <span class="fa fa-file-alt mt-3 mr-2"></span>Aussehen
                                            <input placeholder="Normal gebaut, kurze Gesichtsbehaarung" v-model="appearance" type="text" class="form-control mt-1" maxlength="64">
                                        </li>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                <div class="card-header" style="font-family: 'Exo', sans-serif; font-size: 1.05vw">
                                    <span>Funkgerät</span>
                                    <button v-if="voicerp == 1" @click="setRadioFreq('LS')" type="button" class="btn btn-primary float-right">Lautsprecher an/aus</button>
                                </div>
                                <div class="card-body" style="max-height:25vh; width: 25vw; overflow-x: auto">
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <div class="infoboxtext ml-2">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="text" maxlength="3" class="col-md-5 mt-2 form-control text-center float-right" placeholder="125 mHz" style="border-radius: 1vw" v-model="frequenz" autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <button style="margin-top: 0.3vw" @click="setRadioFreq(frequenz)" type="button" class="btn btn-primary">Einstellen</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setRadioFreq('-1')" type="button" class="btn btn-danger ml-3">Ausschalten</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setRadioFreq('Aus')" type="button" class="btn btn-secondary ml-3">Abbrechen</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                <div class="card-header" style="font-family: 'Exo', sans-serif; font-size: 1.05vw">
                                    ...
                                    <button @click="play3DSound(musiclink, 2)" type="button" class="btn btn-danger float-right">Musik ausschalten</button>
                                </div>
                                <div class="card-body" style="max-height:35vh; width: 25vw; overflow-x: auto">
                                    <div class="col-md-12">
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                            ...
                                            <div class="infoboxtext">
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <input type="text" maxlength="128" class="col-md-12 mt-2 form-control text-center float-left" placeholder="Musiklink" style="border-radius: 1vw" v-model="musiclink" autofocus>
                                                </div>
                                            </div>
                                        </div>
                                        <hr />
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <button style="margin-top: 0.3vw" @click="play3DSound(musiclink, 0)" type="button" class="btn btn-primary">Abspielen</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="play3DSound(musiclink, 1)" type="button" class="btn btn-success ml-3">Pause/Weiter</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="play3DSound(musiclink, -1)" type="button" class="btn btn-secondary ml-3">Abbrechen</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card2 card card-primary card-outline">
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <i class="fas fa-gas-pump fa-4x mt-3" style="color:#3F6791; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"></i>
                                                </div>
                                                ...
                                                <button type="button" class="btn btn-primary mb-2 mr-4 ml-4" @click="startStopFuel()">{{getFuelText()}}</button>
                                                <button type="button" class="btn btn-secondary mb-4 mr-4 ml-4" @click="hideFuelStation(0)">Abbrechen</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 25vw; overflow-x: auto">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <div class="infoboxtext ml-2">
                                                    <label>Grund:</label>
                                                    <input type="text" maxlength="64" class="col-md-12 form-control text-center" placeholder="Grund" style="border-radius: 1vw" v-model="arrestInfo[0]">
                                                </div>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <div class="infoboxtext ml-2 mt-3">
                                                    <label>Summe:</label>
                                                    <input type="text" maxlength="5" class="col-md-12 form-control text-center" placeholder="Angabe in Dollar" style="border-radius: 1vw" v-model="arrestInfo[1]">
                                                </div>
                                            </div>
                                            <hr />
                                        </div>
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <button style="margin-top: 0.3vw" @click="setTicket()" type="button" class="btn btn-primary">Ausstellen</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="hideTicket()" type="button" class="btn btn-secondary ml-3">Abbrechen</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 25vw; overflow-x: auto">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="hideRecept()" type="button" class="btn btn-secondary ml-3">Abbrechen</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body" style="max-height:75vh; width: 30vw; overflow-x: auto">
                                    <div class="col-md-12">
                                        ...
                                        <div v-if="weaponinfo">
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="margin-top: 1.25vw;color:white" @click="startCraft()" type="button" class="btn btn-primary">Craften</button>
                                            </div>
                                        </div>
                                        <div v-if="!weaponinfo">
                                    ...
                                    <div class="col-md-12">
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                            <div class="infoboxtext" v-if="gangzoneprop.length > 0">
                                                ...
                                                <hr />
                                                <button style="margin-top: 0.25vw;color:white" @click="getGangzone()" type="button" class="btn btn-primary float-right">{{gangzone.value}} rausnehmen</button>
                                            </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 25vw; overflow-x: auto">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <div class="infoboxtext ml-2 mt-3">
                                                    <label>Zeit:</label>
                                                    <input type="text" maxlength="4" class="col-md-12 form-control text-center" placeholder="Zeit in Minuten" style="border-radius: 1vw" v-model="arrestInfo[1]">
                                                </div>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <div class="infobt ml-2 mt-3">
                                                    <label>Zelle:</label>
                                                    <input type="text" maxlength="1" class="col-md-12 form-control text-center" placeholder="Zellennummer" style="border-radius: 1vw" v-model="arrestInfo[2]">
                                                </div>
                                            </div>
                                            <hr />
                                        </div>
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <button style="margin-top: 0.3vw" @click="setArrest()" type="button" class="btn btn-primary">Inhaftieren</button>
                                        <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="hideArrest()" type="button" class="btn btn-secondary ml-3">Abbrechen</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center centering">
            <div class="col-md-12 mt-1 animate__animated animate__bounceInUp">
                <div class="passport" style="margin-top: 32vw">
                    <div class="container">
                        <div class="text-center" style="width: 47vw;max-height:7.55vw;background-color: rgba(0, 0, 0, 0.5);border-radius: 0.5vw;text-shadow: 0 0 0.3px #000">
                            ...
                            <button v-if="respawnTime <= 0" style="font-family: 'Exo', sans-serif;" @click="respawn()" type="button" class="btn btn-primary mb-4">Respawn</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 25vw; overflow-x: auto">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card2 card card-primary card-outline" v-if="infoboxtextheader1 || infoboxtextheader2 || infoboxtextheader3 || infoboxtextheader4">
                                                <div class="infoboxtext ml-2">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:65vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/ammunation/Ammu-1.png" :class="[(selectedWeapon == 'Tint') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectWeapon('Tint')">
                                                <img src="../assets/images/ammunation/Ammu-2.png" :class="[(selectedWeapon == 'Components') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectWeapon('Components')">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="selectedWeapon == 'Tint'">
                                        ...
                                        <vue-range-slider v-if="!weaponItem.description || !weaponItem.description.toLowerCase().incluides('mk2')" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" max="7" value='0' :step="1" v-model="weaponNumber" v-oninput="weaponPreview(1, weaponNumber)" />
                                        <vue-range-slider v-else ref="slider" tooltip="false" dotSize="14" height="13" :min="0" max="31" value='0' :step="1" v-model="weaponNumber" v-oninput="weaponPreview(1, weaponNumber)" />
                                    </div>
                                    <div v-if="selectedWeapon == 'Components'">
                                        Waffenkomponente auswählen: <span class="badge badge-secondary">{{weaponComponents[weaponNumber2].Name}}</span>
                                        <span class="ml-2 badge badge-primary">{{ammuPrice2}}$</span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="weaponComponents.length > 1 ? weaponComponents.length-1 : 1" value='0' :step="1" v-model="weaponNumber2" v-oninput="weaponPreview(2, weaponComponents[weaponNumber2].HashKey)" />
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                    ...
                                    <div v-if="selectedWeapon == 'Tint'">
                                        <div v-if="ammuCheck == 0">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(1,weaponNumber, 0)" type="button" class="btn btn-success">Farbton
                                                    kaufen (Bar)</button>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(1,weaponNumber, 1)" type="button" class="btn btn-success">Farbton
                                                    kaufen (EC-Karte)</button>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="resetWeaponComponent(1)" type="button" class="btn btn-warning">Farbton
                                                    reseten</button>
                                            </div>
                                        </div>
                                        <div v-if="ammuCheck == 1">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(1,weaponNumber, 3)" type="button" class="btn btn-success">Farbton
                                                    auswählen</button>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="resetWeaponComponent(1)" type="button" class="btn btn-warning">Farbton
                                    ...
                                    <div v-else>
                                        <div v-if="ammuCheck == 0">
                                            <div v-if="!this.compNow.includes(weaponComponents[weaponNumber2].HashKey)">
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(2,weaponComponents[weaponNumber2].HashKey, 0)" type="button" class="btn btn-success">Komponente kaufen (Bar)</button>
                                                </div>
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(2,weaponComponents[weaponNumber2].HashKey, 1)" type="button" class="btn btn-success">Komponente kaufen (EC-Karte)</button>
                                                </div>
                                            </div>
                                            <div v-else>
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(3,weaponComponents[weaponNumber2].HashKey, 0)" type="button" class="btn btn-danger">Komponente entfernen</button>
                                                </div>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="resetWeaponComponent(2)" type="button" class="btn btn-warning">Komponenten
                                                    reseten</button>
                                            </div>
                                        </div>
                                        <div v-if="ammuCheck == 1">
                                            <div v-if="!this.compNow.includes(weaponComponents[weaponNumber2].HashKey)">
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setWeaponComponent(2,weaponComponents[weaponNumber2].HashKey, 3)" type="button" class="btn btn-success">Komponente auswählen</button>
                                                </div>
                                            </div>
                                            <div v-else>
                                                <div style="display: flex; justify-content: center; align-items: center;">
                    ...
                    <div class="box box-default">
                        <div class="row">
                            <div class="card card-primary card-outline">
                                <div class="card-header" style="font-family: 'Exo', sans-serif; font-size: 1.2vw">
                                    Tuning
                                    <i v-if="perlmutt1 && selectedTuning == 'Farbe 1'" @click="setPerlmutt()" class="fa-solid fa-sun float-right" style="color:#3F6791; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"></i>
                                    <i v-if="!perlmutt1 && selectedTuning == 'Farbe 1'" @click="setPerlmutt()" class="fa-solid fa-sun float-right" style="color:#FFFFFF; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"></i>
                                    <i v-if="perlmutt1 && componentNumbers[69] != 255 && selectedTuning == 'Farbe 1'" @click="resetPerlmutt()" class="fa-solid fa-ban float-right mr-2" style="color:#FFFFFF; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"></i>
                                </div>
                                <div class="card-body" style="max-height:65vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/tuning/1.png" :class="[(selectedTuning == 'Farbe 1') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Farbe 1')">
                                                <img src="../assets/images/tuning/1.png" :class="[(selectedTuning == 'Farbe 2') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Farbe 2')">
                                                <img src="../assets/images/tuning/5.png" :class="[(selectedTuning == 'Farbe 3') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Farbe 3')">
                                                <img src="../assets/images/tuning/2.png" :class="[(selectedTuning == 'Tuning 1') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Tuning 1')">
                                                <img src="../assets/images/tuning/3.png" :class="[(selectedTuning == 'Tuning 2') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Tuning 2')">
                                                <img src="../assets/images/tuning/4.png" :class="[(selectedTuning == 'Tuning 3') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Tuning 3')">
                                                <img src="../assets/images/tuning/6.png" :class="[(selectedTuning == 'Tuning 4') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Tuning 4')">
                                                <img src="../assets/images/tuning/7.png" :class="[(selectedTuning == 'Analyse') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectTuning('Analyse')">
                                            </div>
                                        </div>
                                    </div>
                                    <hr v-if="selectedTuning">
                                    <div class="hair" v-if="selectedTuning == 'Farbe 1' || selectedTuning == 'Farbe 2' || selectedTuning == 'Farbe 3'">
                                        <span class="badge badge-primary mb-3 ml-1">8 Tuningteile</span>
                                        <ul class="vehicleColorsList" v-if="selectedTuning == 'Farbe 1'">
                                            <li v-for="n in 159" :key="n" :style="{ background: vehicleColors[n].Hex }" @click="tuningPreview(66, n)">
                                            </li>
                                        </ul>
                                        <ul class="vehicleColorsList" v-if="selectedTuning == 'Farbe 2'">
                                            <li v-for="n in 159" :key="n" :style="{ background: vehicleColors[n].Hex }" @click="tuningPreview(67, n)">
                                            </li>
                                        </ul>
                                        <ul class="vehicleColorsList" v-if="selectedTuning == 'Farbe 3'">
                                            <li v-for="n in 159" :key="n" :style="{ background: vehicleColors[n].Hex }" @click="tuningPreview(68, n)">
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div v-if="checkTuning(1) == 1">
                                            <div v-for="(component, index) in tuningComponents" :key="index">
                                                <div v-if="component != 'n/A' && index <= 10">
                                                    <span v-if="maxTuning[index] > -1">{{component}} <span class="badge badge-secondary">{{componentNumbers[index]}}</span><span class="badge badge-primary ml-1 mr-1">8 Tuningteile</span></span>
                                                    <vue-range-slider v-if="maxTuning[index] > -1" ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="maxTuning[index]" value='0' :step="1" v-model="componentNumbers[index]" v-oninput="tuningPreview(index, componentNumbers[index])" />
                                                </div>
                                            </div>
                                        </div>
                                        <div v-else>
                                        ...
                                        <div v-if="checkTuning(2) == 1">
                                            <div v-for="(component, index2) in tuningComponents" :key="index2">
                                                <div v-if="component != 'n/A' && index2 > 10 && index2 <= 24">
                                                    <span v-if="maxTuning[index2] > -1 && component != 'Panzerung'">{{component}} <span class="badge badge-secondary">{{getComponentName(index2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[index2]}} Tuningteile</span></span>
                                                    <vue-range-slider v-if="maxTuning[index2] > -1 && component != 'Panzerung'" ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="maxTuning[index2]" value='0' :step="1" v-model="componentNumbers[index2]" v-oninput="tuningPreview(index2, componentNumbers[index2])" />
                                                </div>
                                            </div>
                                        </div>
                                        <div v-else>
                                        ...
                                        <div v-if="checkTuning(3) == 1">
                                            <div v-for="(component, index3) in tuningComponents" :key="index3">
                                                <div v-if="component != 'n/A' && index3 > 24">
                                                    <span v-if="maxTuning[index3] > -1">{{component}} <span class="badge badge-secondary">{{getComponentName(index3)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[index3]}} Tuningteile</span></span>
                                                    <vue-range-slider v-if="maxTuning[index3] > -1" ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="maxTuning[index3]" value='0' :step="1" v-model="componentNumbers[index3]" v-oninput="tuningPreview(index3, componentNumbers[index3])" />
                                                </div>
                                            </div>
                                        </div>
                                        <div v-else>
                                    ...
                                    <div v-if="selectedTuning == 'Tuning 4'">
                                        <span>Turbo PSI <span class="badge badge-secondary">{{parseFloat(componentNumbers[58]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[58]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0.01" :max="2.0" value='0.25' :step="0.01" v-model="componentNumbers[58]" v-oninput="tuningPreview(58, componentNumbers[58])" />
                                        <span>Zündzeitpunkt <span class="badge badge-secondary">{{parseFloat(componentNumbers[59]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[59]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0.01" :max="2.0" value='1.3' :step="0.01" v-model="componentNumbers[59]" v-oninput="tuningPreview(59, componentNumbers[59])" />
                                        <span>Transmission <span class="badge badge-secondary">{{parseFloat(componentNumbers[60]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[60]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="1" :max="50" value='10' :step="1" v-model="componentNumbers[60]" v-oninput="tuningPreview(60, componentNumbers[60])" />
                                        <span>Bremskraft (R/F) <span class="badge badge-secondary">{{parseFloat(componentNumbers[61]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[61]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0.0" :max="2" value='0.5' :step="0.01" v-model="componentNumbers[61]" v-oninput="tuningPreview(61, componentNumbers[61])" />
                                        <span>Bremskraft (W/S) <span class="badge badge-secondary">{{parseFloat(componentNumbers[62]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[62]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0.01" :max="2" value='1.4' :step="0.01" v-model="componentNumbers[62]" v-oninput="tuningPreview(62, componentNumbers[62])" />
                                        <span>Laufwerksvorspannung <span class="badge badge-secondary">{{parseFloat(componentNumbers[63]).toFixed(2)}}</span><span class="badge badge-primary ml-1 mr-1">{{tuningCost[63]}} Tuningteile</span></span>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0.00" :max="1" value='0.5' :step="0.01" v-model="componentNumbers[63]" v-oninput="tuningPreview(63, componentNumbers[63])" />
                                    </div>
                                    <div v-if="selectedTuning == 'Analyse'">
                                        ...
                                        <hr />
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                            <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" type="button" @click="syncTuningFunc(1)" class="btn btn-warning">Tuning
                                                Synchronisieren</button>
                                        </div>
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                            <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="resetTuning(1)" type="button" class="btn btn-danger">Tuning reseten</button>
                                        </div>
                                        <div style="display: flex; justify-content: center; align-items: center;">
                                            <button style="display: flex; justify-content: center; align-items: center; margin-top: 0.3vw" @click="setTuning()" type="button" class="btn btn-success">Tuning anbringen</button>
                                        </div>
                                    </div>
                                    <hr>
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 28.7vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/tattoo.png" :class="[(selectTattoo == 'Tattoo1') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="tattooSelect('Tattoo1')">
                                            </div>
                                            <div v-if="selectTattoo == 'Tattoo1'" style="display: flex; justify-content: center; align-items: center;" class="mt-3">
                                                <button type="button" @click="selectTattoCheck(-1)" :class="[(zoneId == -1) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']" style="display: flex; justify-content: center; align-items: center;">Alle</button>
                                                <button type="button" @click="selectTattoCheck(0)" :class="[(zoneId == 0) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">Körper</button>
                                                <button type="button" @click="selectTattoCheck(1)" :class="[(zoneId == 1) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">Kopf</button>
                                                <button type="button" @click="selectTattoCheck(2)" :class="[(zoneId == 2) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">L.
                                                    Arm</button>
                                                <button type="button" @click="selectTattoCheck(3)" :class="[(zoneId == 3) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">R.
                                                    Arm</button>
                                                <button type="button" @click="selectTattoCheck(4)" :class="[(zoneId == 4) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">L.
                                                    Bein</button>
                                                <button type="button" @click="selectTattoCheck(5)" :class="[(zoneId == 5) ? 'active btn btn-primary btn-sm mr-1':'btn btn-primary btn-sm mr-1']">R.
                                                    Bein</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div v-if="selectTattoo == 'Tattoo1'">
                                            ...
                                            <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="tattooJson.length-1" value='0' :step="1" v-model="selectedclothid" v-oninput="changeTattoo()" />
                                            <hr />
                                        </div>
                                        <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                            <button type="button" v-if="selectedclothid >= 0" class="btn btn-success mr-1" @click="buyTattoo(selectedclothid)">Tattoo stechen/entfernen -
                                                {{parseInt(750*multiplier)}}$</button>
                                            <button type="button" v-if="selectedclothid >= 0" class="btn btn-danger mr-1" @click="resetTattoo()">Entfernen - {{parseInt(1250*multiplier)}}$</button>
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:54vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/haare.png" :class="[(selectedBarber == 'Haare') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectedBarber = 'Haare'">
                                                <img src="../assets/images/haare.png" :class="[(selectedBarber == 'Haare2') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectedBarber = 'Haare2'">
                                                <img src="../assets/images/kamm.png" v-if="gender == 1" :class="[(selectedBarber == 'Bart') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectedBarber = 'Bart'">
                                                <img v-if="bizzid == 38" src="../assets/images/makeup.png" :class="[(selectedBarber == 'Kosmetik') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectedBarber = 'Kosmetik'">
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div v-if="selectedBarber == 'Haare'">
                                        ...
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxhair" value='0' :step="1" v-model="selectedclothid" v-oninput="hairCustomize(1, selectedclothcolor)" />
                                        <hr />
                                        <div class="hair">
                                            <ul class="hairColors-1">
                                                <li v-for="(hairColor, index) in hairColors" :key="hairColor" :style="{ background: hairColor }" v-on:click="hairCustomize(1, index)">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div v-if="selectedBarber == 'Haare2'">
                                        ...
                                        <div class="hair">
                                            <ul class="hairColors-1">
                                                <li v-for="(hairColor, index) in hairColors" :key="hairColor" :style="{ background: hairColor }" v-on:click="hairCustomize(4, index)">
                                                </li>
                                            </ul>
                                        </div>
                                        <hr />
                                    ...
                                    <div v-if="selectedBarber == 'Bart'">
                                        ...
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="28" value='0' :step="1" v-model="selectedclothid2" v-oninput="hairCustomize(2, selectedclothcolor2)" />
                                        <hr />
                                        <div class="beard">
                                            <ul class="beardColors">
                                                <li v-for="beardColor in beardColors" :key="beardColor" :style="{ background: hairColors[beardColor] }" v-on:click="hairCustomize(2, beardColor)">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div v-if="selectedBarber == 'Kosmetik'">
                                        ...
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="33" value='0' :step="1" v-model="headOverlays[0]" v-oninput="miscCustomize(3)" />
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="63" value='0' :step="1" v-model="headOverlaysColors[0]" v-oninput="miscCustomize(3)" />
                                        <h5 class="mt-2">Make-Up Auswahl ({{headOverlays[1]}}):</h5>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="74" value='0' :step="1" v-model="headOverlays[1]" v-oninput="miscCustomize(4)" />
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="63" value='0' :step="1" v-model="headOverlaysColors[1]" v-oninput="miscCustomize(4)" />
                                        <h5 class="mt-2">Lippenstift Auswahl ({{headOverlays[2]}}):</h5>
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="9" value='0' :step="1" v-model="headOverlays[2]" v-oninput="miscCustomize(5, headOverlaysColors[2])" />
                                        <vue-range-slider ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="63" value='0' :step="1" v-model="headOverlaysColors[2]" v-oninput="miscCustomize(5)" />
                                        <hr />
                                    </div>
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                        <button v-if="getBarberPrice() > 0" type="button" class="btn btn-success mr-1" @click="buyHair()">Dienstleistung durchführen - ({{getBarberPrice()}}$)</button>
                                        <button type="button" class="btn btn-danger mr-1" @click="resetHair()">Reset</button>
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 27.5vw; overflow-x: auto">
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/clothshop/maske.png" :class="[(selectedcloth == 'Maske') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Maske')">
                                            </div>
                                        </div>
                                    </div>
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <h5 v-if="selectedcloth != 'n/A'">{{selectedcloth}}nauswahl ({{selectedclothid}}):</h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && selectedcloth != 'Torso'" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    <h5 class="mt-1" v-if="selectedcloth != 'n/A' && maxclothColor > 0">{{selectedcloth}}nvariante ({{selectedclothcolor}}):
                                    </h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && maxclothColor > 1" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxclothColor" value='0' :step="1" v-model="selectedclothcolor" v-oninput="clothingCustomize(2)" />
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <div v-if="selectedcloth != 'n/A'" style="display: flex; justify-content: center; align-items: center;">
                                        <h5>Aktuelle Kosten: {{clothcost}}$</h5>
                                    </div>
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                        <button v-if="selectedcloth != 'n/A' && clothcost > 1" type="button" class="btn btn-success mr-1" @click="buyCloth()">Maske kaufen</button>
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-danger mr-1" @click="resetCloth()">Reset</button>
                    ...
                    <div class="card-body" style="max-height:75vh; width: 27.5vw; overflow-x: auto">
                            ...
                            <div>
                                <div v-for="(wdrobe, index) in wardrobe" :key="index">
                                    <div class="mt-1 col-md-12 col-sm-12 col-xs-12">
                                        <button @click="selectOutfitW(wdrobe)" type="button" class="btn btn-primary btn-block"> <i class="fa-solid fa-shirt mr-3" style="color:white; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;font-size: 0.7vw"></i>
                                            {{wdrobe.name}}</button>
                                    </div>
                                </div>
                                <div v-for="(wdrobe2, index) in wardrobe2" :key="index">
                                    <div class="mt-1 col-md-12 col-sm-12 col-xs-12">
                                        <button type="button" class="btn btn-primary btn-block"> <i class="fa-solid fa-shirt mr-3" style="color:white; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;font-size: 0.7vw"></i>
                                            Leer</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div style="display: flex; justify-content: center; align-items: center;" class="mt-3">
                                <input type="text" maxlength="10" class="col-md-5 mr-3 form-control text-center" placeholder="Outfitname" style="border-radius: 1vw" v-model="outfitname">
                            ...
                            <div class="card card-primary card-outline" v-if="faction != 1 && faction != 2 && faction != 3 && faction != 1337">
                                ...
                                <div class="card-body" style="max-height:60vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/clothshop/kopfbedeckung.png" :class="[(selectedcloth == 'Kopfbedeckung') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Kopfbedeckung')">
                                                <img src="../assets/images/clothshop/brillen.png" :class="[(selectedcloth == 'Brillen') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Brillen')">
                                                <img src="../assets/images/clothshop/torso.png" :class="[(selectedcloth == 'Torso') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Torso')">
                                                <img src="../assets/images/clothshop/oberbekleidung.png" :class="[(selectedcloth == 'Oberbekleidung') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Oberbekleidung')">
                                                <img src="../assets/images/clothshop/tshirt.png" :class="[(selectedcloth == 'T-Shirt') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('T-Shirt')">
                                                <img src="../assets/images/clothshop/hosen.png" :class="[(selectedcloth == 'Hosen') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Hosen')">
                                                <img src="../assets/images/clothshop/schuh.png" :class="[(selectedcloth == 'Schuh') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Schuh')">
                                                <img src="../assets/images/clothshop/krawatte.png" :class="[(selectedcloth == 'Accessoires') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Accessoires')">
                                            </div>
                                        </div>
                                    </div>
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <h5 v-if="selectedcloth != 'n/A'">{{selectedcloth}}auswahl ({{selectedclothid}}):</h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && (selectedcloth == 'Brillen' || selectedcloth == 'Rucksack' || selectedcloth == 'Brillen' || selectedcloth == 'Kopfbedeckung')" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && selectedcloth != 'Brillen' && selectedcloth != 'Rucksack' && selectedcloth != 'Brillen' && selectedcloth != 'Kopfbedeckung'" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    <h5 class="mt-1" v-if="selectedclothid != 'n/A'">{{selectedcloth}}variante ({{selectedclothcolor}}):
                                    </h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && this.selectedcloth != 'Torso' && maxclothColor > 0" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxclothColor" value='0' :step="1" v-model="selectedclothcolor" v-oninput="clothingCustomize(2)" />
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && (this.selectedcloth == 'Torso' || maxclothColor <= 0)" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="0" value='0' :step="1" v-model="clothSetNull" :disabled="true" />
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-success mr-1" @click="buyCloth('dutyCloths')">Dienst beginnen</button>
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-warning mr-1" @click="endCloth(true)">Dienst beenden</button>
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-danger mr-1" @click="resetCloth()">Reset</button>
                                    ...
                                    <div>
                                        <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                            <div v-for="(outfit, index) in outfits" :key="index">
                                                ...
                                                <i @click="deleteOutfit(outfit.id)" class="fa-solid fa-trash mr-1" style="color:rgb(219, 73, 73); text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;font-size: 0.7vw"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div style="display: flex; justify-content: center; align-items: center;" class="mt-3">
                                            <input type="text" maxlength="10" class="col-md-4 mr-3 form-control text-center" placeholder="Outfitname" style="border-radius: 1vw" v-model="outfitname">
                            ...
                            <div class="card card-primary card-outline" v-else>
                                ...
                                <div class="card-body" style="max-height:60vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-1" v-if="faction != 1337">
                                        <button type="button" class="btn btn-success mr-1" @click="buyCloth('dutyCloths')">Dienst beginnen</button>
                                        <button type="button" class="btn btn-warning mr-1" @click="endCloth(true)">Dienst beenden</button>
                                        <button type="button" class="btn btn-secondary" @click="endCloth(false)">Abbrechen</button>
                                    </div>
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-1" v-if="faction == 1337">
                                        <button type="button" class="btn btn-success mr-1" @click="buyCloth('dutyCloths')">Outfit testen</button>
                                        <button type="button" class="btn btn-secondary" @click="endCloth(false)">Abbrechen</button>
                                    </div>
                                    <hr />
                                    <span class="text-center" style="display: flex; justify-content: center; align-items: center;">Benutze
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                ...
                                                <img src="../assets/images/clothshop/oberbekleidung.png" :class="[(selectedcloth == 'Oberbekleidung') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Oberbekleidung')">
                                                <img src="../assets/images/clothshop/tshirt.png" :class="[(selectedcloth == 'T-Shirt') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('T-Shirt')">
                                                <img src="../assets/images/clothshop/rucksack.png" :class="[(selectedcloth == 'Rucksack') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Rucksack')">
                                                <img src="../assets/images/clothshop/hosen.png" :class="[(selectedcloth == 'Hosen') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Hosen')">
                                                <img src="../assets/images/clothshop/schuh.png" :class="[(selectedcloth == 'Schuh') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Schuh')">
                                            </div>
                                        </div>
                                    ...
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <h5 v-if="selectedcloth != 'n/A'">{{selectedcloth}}auswahl ({{selectedclothid}}):</h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && (selectedcloth == 'Brillen' || selectedcloth == 'Rucksack' || selectedcloth == 'Brillen' || selectedcloth == 'Kopfbedeckung')" ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && selectedcloth != 'Brillen' && selectedcloth != 'Rucksack' && selectedcloth != 'Brillen' && selectedcloth != 'Kopfbedeckung'" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                        <button v-if="selectedcloth != 'n/A' && clothcost > 0" type="button" class="btn btn-success mr-1" @click="buyCloth()">Outfit kaufen</button>
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-danger mr-1" @click="resetCloth()">Reset</button>
                                        <button type="button" class="btn btn-secondary" @click="abortCloth()">Abbrechen</button>
                                    </div>
                                    <hr>
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="max-height:50vh; width: 27.5vw; overflow-x: auto">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img src="../assets/images/clothshop/ohrring.png" :class="[(selectedcloth == 'Ohrring') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Ohrring')">
                                                <img src="../assets/images/clothshop/armbanduhr.png" :class="[(selectedcloth == 'Armbanduhr') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Armbanduhr')">
                                                <img src="../assets/images/clothshop/armring.png" :class="[(selectedcloth == 'Armring') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Armring')">
                                                <img src="../assets/images/clothshop/krawatte.png" :class="[(selectedcloth == 'Accessoires') ? 'clothiconactive mr-2':'clothicon mr-2']" @click="selectCloth('Accessoires')">
                                            </div>
                                        </div>
                                    </div>
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <h5 v-if="selectedcloth != 'n/A'">{{selectedcloth}}auswahl ({{selectedclothid}}):</h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A'" ref="slider" tooltip="false" dotSize="14" height="13" :min="-1" :max="maxcloth" value='0' :step="1" v-model="selectedclothid" v-oninput="clothingCustomize(1)" />
                                    <h5 class="mt-1" v-if="selectedcloth != 'n/A' && maxclothColor > 0">{{selectedcloth}}variante ({{selectedclothcolor}}):
                                    </h5>
                                    <vue-range-slider v-if="selectedcloth != 'n/A' && maxclothColor > 0" ref="slider" tooltip="false" dotSize="14" height="13" :min="0" :max="maxclothColor" value='0' :step="1" v-model="selectedclothcolor" v-oninput="clothingCustomize(2)" />
                                    <hr v-if="selectedcloth != 'n/A'" />
                                    <div v-if="selectedcloth != 'n/A'" style="display: flex; justify-content: center; align-items: center;">
                                        <h5>Aktuelle Kosten: {{clothcost}}$</h5>
                                    </div>
                                    <div style="display: flex; justify-content: center; align-items: center;" class="mt-2">
                                        <button v-if="selectedcloth != 'n/A' && clothcost > 0" type="button" class="btn btn-success mr-1" @click="buyCloth()">Sachen kaufen</button>
                                        <button v-if="selectedcloth != 'n/A'" type="button" class="btn btn-danger mr-1" @click="resetCloth()">Reset</button>
                                        <button type="button" class="btn btn-secondary" @click="abortCloth()">Abbrechen</button>
                                    </div>
                                    <hr>
                    ...
                    <div class="box box-default">
                        <div class="card card-primary card-outline">
                            <div class="card-header" style="font-family: 'Exo', sans-serif;"><strong class="ml-2">Beantragung der
                                ...
                                <button type="button" @click="checkEinreise()" class="btn btn-primary float-right" v-if="!einreisefinish">Dokument
                                    abgeben</button>
                            </div>
                            <div class="card-body">
                                <div class="row">
    ...
    <div class="charactercreator" style="background-color:transparent" v-if="showdealershipMenu">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-primary animate__animated animate__fadeIn" style="color:white">
            <div class="hair">
                <ul class="vehicleColorsList">
                    <li v-for="(color, index) in dealerColors" :key="index" @click="selectColor(color.ID)" :style="{ background: color.Hex }">
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div style="overflow: auto" v-if="showdealershipMenu">
        <aside class="main-sidebar sidebar-dark-primary elevation-4 animate__animated animate__fadeIn" style="background-color: #1E282C">
            <a href="#" class="brand-link" style="background-color: #1A2226">
                <strong><span class="brand-text font-weight" style="font-family: 'Exo', sans-serif; display: flex; justify-content: center; align-items: center; font-size: 22px">{{dealerShipName.substring(0,18)}}</span></strong>
            </a>
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" v-for="(vehicle, index) in dealerShipVehicles" :key="index" style="display: flex; justify-content: center; align-items: center;">
                    <strong><a href="#"><span class="brand-text font-weight" style="font-family: 'Exo', sans-serif; font-size: 20px; color: #3F6791" v-if="vehicle.vehiclename == dealerShipVehicle.vehiclename">{{vehicle.vehiclename}} <span style="font-size: 15px" class="badge badge-dark ml-3">{{parseInt(vehicle.price*multiplier)}}$</span></span><span class="brand-text font-weight" style="font-family: 'Exo', sans-serif; font-size: 20px" @click="selectDealerShipVehicle(vehicle.vehiclename)" v-else>{{vehicle.vehiclename}} <span style="font-size: 15px" class="badge badge-dark ml-3">{{parseInt(vehicle.price*multiplier)}}$</span></span></a></strong>
                </div>
            </div>
        </aside>
    </div>
                        ...
                        <div class="row">
                            <div class="card card-primary card-outline">
                                <div class="card-header" style="font-family: 'Exo', sans-serif; font-size: 1.1vw">
                                    ...
                                    <button type="button" class="btn btn-danger float-right" style="color:white" @click="abortDealerShip()">Abbrechen</button>
                                </div>
                                <div class="card-body" style="max-height:50vh; width: 25vw; overflow-x: auto">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32">Geschwindigkeit:</label>
                                            <div v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" :style="{ 'width': parseInt(100/dealerShipMax[0]*dealerShipVehicle.maxspeed) + '%' }"></div>
                                            <label v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" style="margin-top: 0.1vw">Beschleunigung:</label>
                                            <div v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" :style="{ 'width': parseInt((100/parseFloat(dealerShipMax[1])*parseFloat(dealerShipVehicle.maxacceleration))) + '%' }">
                                            </div>
                                            <label v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" style="margin-top: 0.1vw">Bremsen:</label>
                                            <div v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" :style="{ 'width': parseInt((100/parseFloat(dealerShipMax[2])*parseFloat(dealerShipVehicle.maxbraking))) + '%' }">
                                            </div>
                                            <label v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.maxhandling > 0" style="margin-top: 0.1vw">Handling:</label>
                                            <div v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" :style="{ 'width': parseInt((100/parseFloat(dealerShipMax[3])*parseFloat(dealerShipVehicle.maxhandling))) + '%' }">
                                            </div>
                                            <hr v-if="dealerShipVehicle.maxspeed > 1 && dealerShipVehicle.bizzid != 31 && dealerShipVehicle.bizzid != 32" />
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                ...
                                                <button type="button" class="btn btn-success ml-3" @click="buyVehicle(2)">Kaufen
                                                    (EC-Karte)</button>
                                                <button v-if="dealerShipVehicle.fuel > 0" type="button" class="btn btn-primary ml-3" @click="testDealerShip()">Probefahrt</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        clothingCustomize: function (id, direction = 1) {
            let selected = 0;
            if (id == 1) {
            ...
            if (this.selectedcloth == 'Schuh') {
                ...
                const invalidList = (this.gender == 1) ? invalidMenShoe : invalidWomanShoe;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                const invalidList = (this.gender == 1) ? invalidMenLeg : invalidWomanLeg;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                const invalidList = (this.gender == 1) ? invalidMenTorso : invalidWomanTorso;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                const invalidList = (this.gender == 1) ? invalidMenTop : invalidWomanTop;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                const invalidList = (this.gender == 1) ? invalidMenTShirt : invalidWomanTShirt;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                selected = this.selectedclothid;
                const invalidList = (this.gender == 1) ? invalidMenGlasses : invalidWomanGlasses;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                selected = this.selectedclothid;
                const invalidList = (this.gender == 1) ? invalidMenBags : invalidWomanBags;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                const invalidList = (this.gender == 1) ? invalidMenHats : invalidWomenHats;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                selected = this.selectedclothid;
                const invalidList = (this.gender == 1) ? invalidMenOhrring : invalidWomanOhrring;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                selected = this.selectedclothid;
                const invalidList = (this.gender == 1) ? invalidMenArmbanduhr : invalidWomanArmbanduhr;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
                ...
                selected = this.selectedclothid;
                const invalidList = (this.gender == 1) ? invalidMenArmring : invalidWomanArmring;
                this.selectedclothid = this.getValidId(invalidList, selected, direction);
                this.selected = this.selectedclothid;
