                ...
                <div class="col-md-12 mt-1">
                    <div class="box box-default">
                        <div class="card card-primary card-outline">
                            <div v-if="atbank==0" class="card-header" style="font-family: 'Exo', sans-serif">Maze Bank - Gestión de cuenta <div class="float-right" style="font-family: 'Exo', sans-serif" @click="newPin()"><b style="cursor:pointer">Nuevo PIN</b></div>
                            </div>
                            <div v-if="atbank==1" class="card-header" style="font-family: 'Exo', sans-serif">Fleeca Bank - Gestión de cuenta <div class="float-right" style="font-family: 'Exo', sans-serif" @click="newPin()"><b style="cursor:pointer">Nuevo PIN</b></div>
                            </div>
                            <div v-if="atbank==2" class="card-header" style="font-family: 'Exo', sans-serif">Bankautomat - Gestión de cuenta <div class="float-right" style="font-family: 'Exo', sans-serif" @click="newPin()"><b style="cursor:pointer">Nuevo PIN</b></div>
                            </div>
